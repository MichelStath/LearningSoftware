...
{
    public partial class SkillsTestPage : UserControl
    {
        Student currentStudent = new Student();
        bool canSubmit = false;
        public int grade = 0;
        public SkillsTestPage(Student student)
        {
            InitializeComponent();
            Dock = DockStyle.Fill;
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if ((ans1.Length == 1 && ans2.Length == 1 && ans3.Length == 1 && ans4.Length == 1))
            {
                ...
                {
                    asn1LB.Text = "Λάθος απάντηση.Η σωστή απάντηση ειναι το 'a'";
                ...
                {
                    asn2LB.Text = "Λάθος απάντηση.Η σωστή απάντηση ειναι το 'b'";
                ...
                {
                    asn3LB.Text = "Λάθος απάντηση.Η σωστή απάντηση ειναι το 'a'";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (canSubmit)
            {
                Helper.AddTestGrade(currentStudent.S_ID, TestEnum.SKILLS, grade);
