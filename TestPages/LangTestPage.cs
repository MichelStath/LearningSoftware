...
{
    public partial class LangTestPage : UserControl
    {
        Student currentStudent = new Student();
        bool canSubmit = false;
        public int grade = 0;
        public LangTestPage(Student student)
        {
            InitializeComponent();
            Dock = DockStyle.Fill;
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            string[] array = { "JavaScript", "PHP", "Lua", "Bash", "PowerShel" };
            bool a = Array.Exists(array, element => element == ans2);

            if ((ans1.Length == 1 && ans2.Length > 0 && ans3.Length == 1 && ans4.Length == 1))
            {
                lockTB();
                if (ans1 == "b")
                {
                ...
                {
                    asn1LB.Text = "Λάθος απάντηση.Η σωστή απάντηση ειναι το 'b'";
                ...
                {
                    asn2LB.Text = "Λάθος απάντηση. Στις Scripting γλώσσες ανοίκουν οι : JavaScript, PHP, Lua, Bash, PowerShel";
                ...
                {
                    asn3LB.Text = "Λάθος απάντηση.Η σωστή απάντηση ειναι το 'b'";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (canSubmit)
            {
                Helper.AddTestGrade(currentStudent.S_ID, TestEnum.LANG, grade);
